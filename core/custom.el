(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (use-package ox-reveal outshine org-bullets ivy-hydra htmlize gotest go-snippets go-guru go-errcheck go-eldoc diminish dashboard counsel-projectile company-go company-c-headers command-log-mode clang-format bm avy arjen-grey-theme))))
(custom-set-faces
